  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at center, rgba(40,75,99,0.22) 0%, transparent 70%)',
          transform: 'scale(1.2)',
        }}
      />
        ...
        >
          <defs>
            <linearGradient id="frameFill" x1="0" y1="0" x2="1" y2="1">
              <stop offset="0%" stopColor="#153243" />
              <stop offset="100%" stopColor="#0F1E2B" />
            </linearGradient>
            <linearGradient id="screenFill" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#0F1E2B" />
              <stop offset="100%" stopColor="#0A1828" />
            </linearGradient>
            <linearGradient id="btnGrad" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor="#284B63" />
              <stop offset="100%" stopColor="#153243" />
            </linearGradient>
          ...
          {/* Side buttons */}
          <rect x="0" y="100" width="4" height="28" rx="2" fill="#153243" />
          <rect x="0" y="136" width="4" height="28" rx="2" fill="#153243" />
          <rect x="196" y="120" width="4" height="40" rx="2" fill="#153243" />

          {/* Screen */}
          <rect x="16" y="26" width="168" height="350" rx="20" fill="url(#screenFill)" />

          {/* Dynamic island */}
          <rect x="72" y="34" width="56" height="14" rx="7" fill="#0A1828" />

          {/* Screen content (clipped) */}
          <g clipPath="url(#screenClip)">

            {/* Navbar */}
            <rect x="16" y="26" width="168" height="26" fill="#153243" />
            <rect x="26" y="33" width="32" height="10" rx="5" fill="#284B63" />
            <rect x="128" y="35" width="18" height="6" rx="3" fill="#334155" />
            <rect x="152" y="35" width="18" height="6" rx="3" fill="#334155" />

            {/* Hero bg */}
            <rect x="16" y="52" width="168" height="108" fill="#0F1E2B" />

            {/* Badge */}
            <rect x="26" y="60" width="60" height="10" rx="5" fill="#153243" />
            <rect x="30" y="63" width="52" height="4" rx="2" fill="#B4B8AB" opacity="0.7" />

            {/* Headline */}
            <rect x="26" y="76" width="130" height="11" rx="4" fill="#F8FAFC" />
            <rect x="26" y="92" width="110" height="11" rx="4" fill="#F8FAFC" />
            <rect x="26" y="108" width="80" height="11" rx="4" fill="#B4B8AB" />
            ...
            <rect x="106" y="148" width="62" height="16" rx="8" fill="#153243" stroke="#334155" strokeWidth="1" />

            {/* Features section */}
            <rect x="16" y="168" width="168" height="76" fill="#153243" />
            <rect x="24" y="178" width="70" height="56" rx="10" fill="#153243" />
            <rect x="102" y="178" width="70" height="56" rx="10" fill="#153243" />

            {/* Icons on cards */}
            <circle cx="49" cy="197" r="9" fill="rgba(59,130,246,0.15)" />
            <circle cx="49" cy="197" r="5" fill="#284B63" />
            ...
            <rect x="32" y="222" width="38" height="5" rx="3" fill="#153243" />
            <rect x="110" y="212" width="52" height="6" rx="3" fill="#334155" />
            <rect x="110" y="222" width="38" height="5" rx="3" fill="#1A3520" />

            {/* Stats strip */}
            <rect x="16" y="248" width="168" height="52" fill="#0F1E2B" />
            <rect x="24" y="258" width="44" height="24" rx="6" fill="#153243" />
            <rect x="78" y="258" width="44" height="24" rx="6" fill="#153243" />
            <rect x="132" y="258" width="44" height="24" rx="6" fill="#153243" />
            <rect x="30" y="264" width="32" height="7" rx="2" fill="#284B63" />
            <rect x="84" y="264" width="32" height="7" rx="2" fill="#284B63" />
            <rect x="138" y="264" width="32" height="7" rx="2" fill="#284B63" />
            ...
            {/* Testimonial */}
            <rect x="16" y="304" width="168" height="50" fill="#153243" />
            <rect x="24" y="312" width="152" height="34" rx="8" fill="#153243" />
            ...
            {/* Footer */}
            <rect x="16" y="358" width="168" height="36" fill="#0F1E2B" />
            <rect x="26" y="368" width="44" height="8" rx="3" fill="#284B63" opacity="0.6" />

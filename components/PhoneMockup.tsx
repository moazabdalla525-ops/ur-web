  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at center, rgba(30,64,175,0.18) 0%, transparent 70%)',
          transform: 'scale(1.2)',
        }}
      />
      ...
      >
        ...
        >
          ...
          <g clipPath="url(#screenClip)">
            ...
            <rect x="26" y="33" width="32" height="10" rx="5" fill="#1E40AF" />
            ...
            <rect x="30" y="63" width="52" height="4" rx="2" fill="#93C5FD" opacity="0.7" />
            ...
            <circle cx="49" cy="197" r="5" fill="#1E40AF" />
            ...
            <rect x="30" y="264" width="32" height="7" rx="2" fill="#1E40AF" />
            <rect x="84" y="264" width="32" height="7" rx="2" fill="#1E40AF" />
            <rect x="138" y="264" width="32" height="7" rx="2" fill="#1E40AF" />
            ...
            <rect x="26" y="368" width="44" height="8" rx="3" fill="#1E40AF" opacity="0.6" />
